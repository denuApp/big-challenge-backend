...
Route::middleware('auth:sanctum')->post('get-submissions', GetSubmissionsController::class);
Route::middleware('auth:sanctum')->get('get-one-submission/{submission}', GetOneSubmissionsController::class);
